...
public:
	...
	public:
		...
		CExtCmdIcon m_icon;
		HWND m_hWndPage;
		ITEM_DATA( CExtCmdIcon & icon, LPCTSTR strText)
			: m_icon( icon )
			, m_strText( strText )
		{
		}
	...
	public:
		...
		void DrawItem( INT nIconAreaWidth, LPDRAWITEMSTRUCT lpDrawItemStruct, CFont* pFont);
		void MeasureItem( LPMEASUREITEMSTRUCT lpMeasureItemStruct, CSize _sizeClientArea, CFont* pFont );
...
public:
	...
	void AddIcon( CExtCmdIcon& icon, LPCTSTR strComment);
