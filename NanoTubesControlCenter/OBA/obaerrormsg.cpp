...
char szOBAErrorMessage_en[][80] = {
	...
	{"FLOW: Invalid parameters"},	//92
	{"PRESSURE: Invalid parameters"},	//93
	{"TEMPERATURE: Invalid parameters"},	//94	
	{"FRACTION: Invalid parameters"},	//95
	{"PLASMATRON: Invalid parameters"},	//96	
	{"CHECK: Invalid id"}, //97
	{"SWITCH: Invalid id"}, //98
	{"FLOW: Invalid id"}, //99
	{"PRESSURE: Invalid id"}, //100
	{"TEMPERATURE: Invalid id"}, //101
	{"FRACTION: Invalid id"}, //102
	{"PLASMATRON: Invalid id"} //103
};

char szOBAErrorMessage_ru[][110] = {
	...
	{"FLOW: Неверные параметры"}, //92
	{"PRESSURE: Неверные параметры"}, //93
	{"TEMPERATURE: Неверные параметры"}, //94
	{"FRACTION: Неверные параметры"}, //95
	{"PLASMATRON: Неверные параметры"}, //96
	{"CHECK: Неверный идентификатор"}, //97
	{"SWITCH: Неверный идентификатор"}, //98
	{"FLOW: Неверный идентификатор"}, //99
	{"PRESSURE: Неверный идентификатор"}, //100
	{"TEMPERATURE: Неверный идентификатор"}, //101
	{"FRACTION: Неверный идентификатор"}, //102
	{"PLASMATRON: Неверный идентификатор"} //103

};

const char* OBAError(int code, bool bRussian/* = false*/)
{
	if (bRussian)
	{
		if (code > sizeof(szOBAErrorMessage_ru)/sizeof(szOBAErrorMessage_ru[0]))
			return "Invalid error code";

		return szOBAErrorMessage_ru[code];
	}
	else
	{
		if (code > sizeof(szOBAErrorMessage_en)/sizeof(szOBAErrorMessage_en[0]))
			return "Invalid error code";

		return szOBAErrorMessage_en[code];
	}
}